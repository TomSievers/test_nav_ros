...
PLUGINLIB_EXPORT_CLASS(object_layer::SimpleLayer, costmap_2d::Layer)
...
namespace object_layer
{
                                            ...
                                            int max_j)
    {
        ...
        unsigned int mx;
        unsigned int my;
        for(double x = mark_x_; x < max_j; x+=master_grid.getResolution())
        {
            
            if(master_grid.worldToMap(x, mark_y_, mx, my)){
